  ...
  $.fn.birthdaypicker = function( options ) {
    ...
    return this.each(function() {
      ...
      var $fieldset = $("<fieldset class='birthday-picker'></fieldset>"),
          $year = $("<select class='birth-year' id='birth[year]' name='birth[year]'></select>"),
          $month = $("<select class='birth-month' id='birth[month]' name='birth[month]'></select>"),
          $day = $("<select class='birth-day' id='birth[day]' name='birth[day]'></select>");
